(function(){
  ...
  function savePNG(){
    ...
    a.href=c.toDataURL('image/png'); a.download='grundriss-skizze.png'; a.click();
  }
  window.addEventListener('DOMContentLoaded', ()=>{
    ...
    if(holder){
      ...
      bar.innerHTML = `
        ...
        <span class="small text-muted">Tasten: Pfeile bewegen, [Entf] löscht letzten Block</span>`;
      ...
      window.addEventListener('keydown', (e)=>{
        ...
        if(e.key==='Delete'){ window.blocks.pop(); }
